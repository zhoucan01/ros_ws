...
namespace small_point_lio {
    ...
    public:
        ...
        Eigen::Matrix<state::value_type, 3, 1> wheel_linear_velocity;
        Eigen::Matrix<state::value_type, 3, 1> wheel_angular_velocity;
        double wheel_rms{0.0};
        Estimator();
        void reset();
        ...
        void h_wheel(const state &s, wheel_measurement_result &measurement_result);
    };
}// namespace small_point_lio