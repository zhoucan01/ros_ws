...
private:
  ...
  bool free_pass_mask_enabled_{};
  std::string free_pass_mask_yaml_filename_;
  std::string free_pass_mask_frame_;
  double free_pass_mask_resolution_{};
  double free_pass_mask_origin_x_{};
  double free_pass_mask_origin_y_{};
  double free_pass_mask_occupied_threshold_{};
  bool free_pass_mask_negate_{};
  unsigned int free_pass_mask_width_{};
  unsigned int free_pass_mask_height_{};
  std::vector<uint8_t> free_pass_mask_data_;
};
