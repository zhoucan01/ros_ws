...
def generate_launch_description():
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            ...
            Node(
                ...
                condition=IfCondition(use_small_gicp),
                output="screen",
                respawn=use_respawn,
                respawn_delay=2.0,
    ...
    load_small_gicp_composable_node = LoadComposableNodes(
        condition=IfCondition(PythonExpression([use_composition, " and ", use_small_gicp])),
        target_container=container_name_full,
        composable_node_descriptions=[
            ComposableNode(
                package="small_gicp_relocalization",
